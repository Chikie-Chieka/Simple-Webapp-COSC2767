...
<html lang="en">
  ...
  <body>
	...
	%>
	<p style="color: red;"><b>A new log entry was just added to /usr/local/tomcat/logs/app.log!</b></p>	
    <!-- The content of the website starts here now! -->
    <div class="jumbotron">
      <h1 class="display-4">THIS IS CHI'S CONFIGURATION TO TEST IF DOCKER WORKS WITH POOL SCM</h1>
